...
(function e(t, n, r) {
...
})(
  {
                  ...
                  snapshot: {
                    ...
                    members: {
                      ...
                      contacts: {
                        ...
                        member: {
                          type: 'structure',
                          required: ['contactId', 'type', 'state', 'queueTimestamp', 'connections', 'attributes'],
                          members: {
                            contactId: {},
                            initialContactId: {},
                            type: {},
    ...
    9: [
      ...
      { './core': 10, './credentials': 11, './credentials/credential_provider_chain': 13 },
    ],
    10: [
      function(require, module, exports) {
    ...
    12: [
      function(require, module, exports) {
        ...
        AWS.CognitoIdentityCredentials = AWS.util.inherit(AWS.Credentials, {
          ...
          createClients: function() {
            ...
            this.cognito = this.cognito || new CognitoIdentity({ params: this.params });
      ...
      { '../../clients/cognitoidentity': 5, '../../clients/sts': 6, '../core': 10 },
    ],
    13: [
      function(require, module, exports) {
        var AWS = require('../core');
        ...
        AWS.ParamValidator = AWS.util.inherit({
          ...
          validate: function validate(shape, params, context) {
            ...
            if (this.errors.length > 1) {
              ...
              throw AWS.util.error(new Error(msg), { code: 'MultipleValidationErrors', errors: this.errors });
    ...
    30: [
      ...
      { '../core': 10, '../model/shape': 27, '../query/query_param_serializer': 34, '../util': 52 },
    ],
    31: [
      function(require, module, exports) {
        var util = require('../util');
    ...
    32: [
      ...
      { '../json/builder': 20, '../json/parser': 21, '../util': 52, './json': 29, './rest': 31 },
    ],
    33: [
      function(require, module, exports) {
        var AWS = require('../core');
    ...
    45: [
      ...
      { '../core': 10, './presign': 44, './s3': 46, './v2': 47, './v3': 48, './v3https': 49, './v4': 50 },
    ],
    46: [
      function(require, module, exports) {
        var AWS = require('../core');
        ...
        (function(process) {
          ...
          var util = {
            ...
            extractRequestId: function extractRequestId(resp) {
              var requestId =
                resp.httpResponse.headers['x-amz-request-id'] || resp.httpResponse.headers['x-amzn-requestid'];
                  ...
                  function(httpResponse) {
                    ...
                    httpResponse.on('end', function() {
                      ...
                      if (statusCode < 300) {
                        ...
                        var err = util.error(new Error(), { retryable: statusCode >= 500 || statusCode === 429 });
              ...
              if (isWhere) {
                ...
                while (othIndex--) {
                  ...
                  result =
                    ...
                    equalFunc(arrValue, othValue, customizer, isWhere, stackA, stackB);
                  if (result) {
                    break;
                  }
                }
            ...
            if (result) {
              ...
              if (typeof result == 'undefined') {
                result =
                  ...
                  equalFunc(objValue, othValue, customizer, isWhere, stackA, stackB);
              }
            }
            if (!result) {
              return false;
    ...
    103: [
      ...
      { '../internal/isLength': 96, '../internal/isObjectLike': 97, './isNative': 106 },
    ],
    104: [
      function(require, module, exports) {
    ...
    111: [
      ...
      { '../internal/baseCopy': 73, '../internal/baseCreate': 74, '../internal/isIterateeCall': 95, './keys': 112 },
    ],
    112: [
      function(require, module, exports) {
        var isLength = require('../internal/isLength'),
      ...
      { '../internal/isLength': 96, '../internal/shimKeys': 100, '../lang/isNative': 106, '../lang/isObject': 107 },
    ],
    113: [
      function(require, module, exports) {
        var isArguments = require('../lang/isArguments'),
    ...
    130: [
      ...
      { './XMLDeclaration': 137, './XMLDocType': 138, './XMLElement': 139, './XMLStringifier': 143 },
    ],
    131: [
      function(require, module, exports) {
        (function() {
    ...
    137: [
      ...
      { './XMLNode': 140, 'lodash/lang/isObject': 107, 'lodash/object/create': 111 },
    ],
    138: [
      function(require, module, exports) {
        (function() {
...
(function() {
  ...
  connect.CONTACT_ACTIVE_STATES = connect.makeEnum(['incoming', 'connecting', 'connected']);
...
(function() {
  ...
  connect.core.initRingtoneEngines = function(params) {
    ...
    var setupRingtoneEngines = function(ringtoneSettings) {
      ...
      connect.assertTrue(
        ringtoneSettings.queue_callback.ringtoneUrl || ringtoneSettings.queue_callback.disabled,
  ...
  AgentDataProvider.prototype._fireAgentUpdateEvents = function(oldAgentData) {
    ...
    connect.values(diff.removed).forEach(function(contactData) {
      ...
      self.bus.trigger(
        connect.core.getContactEventName(connect.ContactEvents.DESTROYED, contactData.contactId),
  ...
  AgentDataProvider.prototype._fireContactUpdateEvents = function(contactId, oldContactState, newContactState) {
    ...
    self.bus.trigger(
      connect.core.getContactEventName(connect.ContactEvents.REFRESH, contactId),
  ...
  connect.core.agentRoutingEventGraph = new connect.EventGraph()
    .assoc(connect.EventGraph.ANY, connect.AgentStateType.ROUTABLE, connect.AgentEvents.ROUTABLE)
    .assoc(connect.EventGraph.ANY, connect.AgentStateType.NOT_ROUTABLE, connect.AgentEvents.NOT_ROUTABLE)
    .assoc(connect.EventGraph.ANY, connect.AgentStateType.OFFLINE, connect.AgentEvents.OFFLINE);
  ...
  connect.core.agentStateEventGraph = new connect.EventGraph()
    .assoc(connect.EventGraph.ANY, connect.values(connect.AgentErrorStates), connect.AgentEvents.ERROR)
    .assoc(connect.EventGraph.ANY, connect.AgentAvailStates.AFTER_CALL_WORK, connect.AgentEvents.ACW);
  ...
  connect.core.contactEventGraph = new connect.EventGraph()
    .assoc(connect.EventGraph.ANY, connect.ContactStateType.INCOMING, connect.ContactEvents.INCOMING)
    .assoc(connect.EventGraph.ANY, connect.ContactStateType.PENDING, connect.ContactEvents.PENDING)
    .assoc(connect.EventGraph.ANY, connect.ContactStateType.CONNECTING, connect.ContactEvents.CONNECTING)
    .assoc(connect.EventGraph.ANY, connect.ContactStateType.CONNECTED, connect.ContactEvents.CONNECTED)
    .assoc(connect.ContactStateType.INCOMING, connect.ContactStateType.ERROR, connect.ContactEvents.MISSED)
    .assoc(connect.EventGraph.ANY, connect.ContactStateType.ENDED, connect.ContactEvents.ACW)
    .assoc(
